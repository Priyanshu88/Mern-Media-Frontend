...
//           return oldPost._id !== deletePost.result._id // return thr post whose id don't match the deleted id
//         });
//         setPosts(newPostArr);
//       }).catch((error) => {
//         console.log(error);
...
//                 <img className='profilePic' src={post.author.profilePic} alt="Profile Picture" />
...
//                       className="material-icons"
//                       style={{ color: "blue", marginRight: "10px", cursor: "pointer" }}>thumb_up</i>
//                 }
...
//                     return (
//                       <h6 key={post._id}>
//                         <img className='profiePic' src={comment.commentedBy.profilePicUrl} alt="Profile picture" />
