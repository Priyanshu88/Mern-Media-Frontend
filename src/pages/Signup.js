...
//       if(data.error)
//       {
//         M.toast({ html: data.error, class: "#c62828 red darken-3" });
//       }
//       else
//       {
//         M.toast({ html: data.result, class: "#388e3c green darken-2" });
//         navigate("/login"); // might get error here
//       }
//     }).catch(error => {
//       console.log(error);
//     })
...
//         <button onClick={() => register()} className="btn wave-effect waves-light btn-large #64b5f6 blue darken-1">Signup</button>
