...
//                     }
//                     else {
//                         M.toast({ html: "Post created successfully!", class: "#388e3c green darken-2" });
...
//                 </div>
//             </div>
//             <button onClick={() => submitPost()} className="btn wave-effect waves-light btn-large #64b5f6 blue darken-1">Submit Post</button>
